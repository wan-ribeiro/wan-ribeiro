...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.section-header, .about-text, .skills-visual');
...
style.textContent = `
    .section-header, .about-text, .skills-visual {
        opacity: 0;
        transform: translateY(30px);
        transition: opacity 0.8s ease, transform 0.8s ease;
    }
    
    .section-header.revealed, .about-text.revealed, .skills-visual.revealed {
        opacity: 1;
